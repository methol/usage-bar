...
| `2026-05-13-code-structure-hygiene` | 代码结构治理：目录分 9 子目录（Providers/Core+per-provider）+ UsageService 移进 Providers/Claude/ 同文件 // MARK: 章节化 + demo.png 清理 + AppResources 改名 BundleLocator | draft | v0.3.2 | [文件](./2026-05-13-code-structure-hygiene.md) |
