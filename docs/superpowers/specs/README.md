...
| `2026-05-12-codex-provider` | Codex provider 第一条数据源：`CodexProvider: UsageProvider` 读 `~/.codex/auth.json` OAuth → `wham/usage`，复用 v0.2.5 泛化视图层 | accepted（spec_criteria 全 done，待 G5/merge） | v0.2.6 | [文件](./2026-05-12-codex-provider.md) |
