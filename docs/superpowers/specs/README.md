...
| `2026-05-13-docs-cleanup` | 文档治理整理：AI 入口分层（AGENTS.md 3 层）+ 新建 docs/agents/{quickstart,operations,conventions}.md + 修复 versions/specs README 状态 drift | implemented | v0.5.0 | [文件](./2026-05-13-docs-cleanup.md) |
