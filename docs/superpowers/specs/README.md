...
| `2026-05-13-view-layer-modernization` | View 层现代化：GCD 清理（2 处）+ chartXSelection 替换 GeometryReader + PopoverView 5 个 @ViewBuilder private var → private nested struct | draft | v0.4.0 | [文件](./2026-05-13-view-layer-modernization.md) |
